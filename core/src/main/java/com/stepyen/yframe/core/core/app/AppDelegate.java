...
public class AppDelegate implements IApp, IAppLifecycles {
    ...
    /**
     * 将 {@link IAppComponent} 返回出去, 供其它地方使用, {@link IAppComponent} 接口中声明的方法返回的实例, 在 {@link #getAppComponent()} 拿到对象后都可以直接使用
     *
     * @return AppComponent
     */
    @NonNull
    ...
    public IAppComponent getAppComponent() {
        Preconditions.checkNotNull(mAppComponent,
                ...
                IAppComponent.class.getName(), getClass().getName(), mApplication == null
    ...
    private static class AppComponentCallbacks implements ComponentCallbacks2 {
        ...
        AppComponentCallbacks(Application application, IAppComponent appComponent) {
            this.mApplication = application;
