...
public final class AppManager {
     ...
     * 通过 {@link IAppLifecycles#onCreate(Application)} 在 App 初始化时,使用此方法传入自定义的 {@link HandleListener}
     *
     ...
     * 所以在栈顶的 {@link Activity} 执行 {@link Activity#onCreate(Bundle)} 方法时使用 {@link #getCurrentActivity()} 获取的就不是当前栈顶的 {@link Activity}, 可能是上一个 {@link Activity}
